...
@Schema(description = "Multipart payload for streaming platform creation")
public record CreateStreamingPlatformDTO(
        ...
        @Schema(description = "Streaming platform logo image", type = "string", format = "binary")
        MultipartFile logo
) {
}
